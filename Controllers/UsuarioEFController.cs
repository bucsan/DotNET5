...
{
    public class UsuarioEFController : Controller
    {
        private readonly IUsuarioEFRepository _usuarioRepository;

        public UsuarioEFController(IUsuarioEFRepository usuarioRepository)
        {
